...
<div>
  ...
  <div className="centered"><h1 style={{color: 'white'}} >Seed Prices Information</h1> </div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-12">
          <div className="gallery_main_2 clearfix">
          </div> 
          <div className="col-sm-4 padding_all">
            <div className="gallery_1">
              {/* normal */}
              <div className="ih-item square effect15 left_to_right"><a href="#">
                  <div className="img"><img src="images/1.jpeg" width="100%" alt="img" /></div>
                  <div className="info">
                    <h3>Wheat</h3>
          ...
          <div className="col-sm-4 padding_all">
            <div className="centered3">
              <div className="gallery_1">
                {/* normal */}
                <div className="ih-item square effect15 left_to_right"><a href="#">
                    <div className="img"><img src="images/2.jpeg" width="100%" alt="img" /></div>
                    <div className="info">
                      <h3>Maize</h3>
            ...
            <div className="col-sm-4 padding_all">
              <div className="centered4">
                <div className="gallery_1">
                  {/* normal */}
                  <div className="ih-item square effect15 left_to_right"><a href="#">
                      <div className="img"><img src="images/3.jpeg" width="100%" alt="img" /></div>
                      <div className="info">
                        <h3>Rice</h3>
            ...
            <div className="col-sm-4 padding_all">
              <div className="centered5">
                <div className="gallery_1">
                  {/* normal */}
                  <div className="ih-item square effect15 left_to_right"><a href="#">
                      <div className="img"><img src="images/4.jpeg" width="100%" alt="img" /></div>
                      <div className="info">
                        <h3>Millet</h3>
            ...
            <div className="col-sm-4 padding_all">
              <div className="centered6">
                <div className="gallery_1">
                  {/* normal */}
                  <div className="ih-item square effect15 left_to_right"><a href="#">
                      <div className="img"><img src="images/5.jpeg" width="100%" alt="img" /></div>
                      <div className="info">
                        <h3>Coffee</h3>
            ...
            <div className="col-sm-4 padding_all">
              <div className="centered7">
                <div className="gallery_1">
                  {/* normal */}
                  <div className="ih-item square effect15 left_to_right"><a href="#">
                      <div className="img"><img src="images/6.jpeg" width="100%" alt="img" /></div>
                      <div className="info">
                        <h3>Tea</h3>
            ...
            <div className="col-sm-4 padding_all">
              <div className="centered8"> 
                <div className="gallery_1">
                  {/* normal */}
                  <div className="ih-item square effect15 left_to_right"><a href="#">
                      <div className="img"><img src="images/7.jpeg" width="100%" alt="img" /></div>
                      <div className="info">
                        <h3>Rubber</h3>
  ...
  <img src="https://cdn.shopify.com/s/files/1/0045/8493/1441/files/decora_480x480.jpg?v=1603285278" alt="Rubber plant" align="Right" height="511px" width="650px" />
  <div className="boxx">
